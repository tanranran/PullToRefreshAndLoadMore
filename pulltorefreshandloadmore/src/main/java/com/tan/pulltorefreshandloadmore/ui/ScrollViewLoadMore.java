 ...
 * Time: 15:54
 */
public class ScrollViewLoadMore extends ScrollView implements OnScrollBottomListener{
    /**
     * 加载更多UI
     */
    ...
    public ScrollViewLoadMore(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ScrollViewLoadMore(Context context, AttributeSet attrs, int defStyleAttr) {
